...
return [
    ...
    'lte' => [
        ...
        'string' => 'Полето :attribute трябва да е по-малко от или равно на :value знака.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'Даденият :attribute се появи при изтичане на данни. Моля, изберете друг :attribute.',
    ],
    ...
    'present_with' => 'Полето :attribute трябва да присъства, когато има :values.',
    ...
    'required_if_declined' => 'Полето :attribute е задължително, когато :other е отхвърлен.',
    ...
    'required_without_all' => 'Полето :attribute е задължително, когато няма нито едно от :values.',
