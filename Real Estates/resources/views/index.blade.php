...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/featured-property.css') }}">
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-8">
          <ul class="info">
            <li style="margin-right: 10vh"><i class="fa fa-envelope"></i> info@company.com</li>
            <li style="margin-right: 10vh;"><i class="fa fa-map"></i> Sunny Isles Beach, FL 33160</li>
          </ul>
        </div>
  ...
  <x-app-layout>
    ...
    <div class="col-lg-11 col-md-9">
      <x-featured-property :property="$property" />
    </div>
        ...
        <div class="row">
          <div class="col-lg-4 offset-lg-4">
            <div class="section-heading text-center">
              <h6>| {{__('Video View')}}</h6>
              <h2>{{__('Get Closer View & Different Feeling')}}</h2>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="counter">
                    ...
                    <p class="count-text ">{{__('Buildings')}}<br>{{__('Finished Now')}}</p>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="counter">
                    <h2 class="timer count-title count-number" data-to="12" data-speed="1000"></h2>
                    <p class="count-text ">{{__('Years')}}<br>{{__('Experience')}}</p>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="counter">
                    <h2 class="timer count-title count-number" data-to="24" data-speed="1000"></h2>
                    <p class="count-text ">{{__('Awwards')}}<br>{{__('Won')}} 2023</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 offset-lg-4">
            <div class="section-heading text-center">
              <h6>| {{__('Properties')}}</h6>
              <h2>{{__('We Provide The Best Property You Like')}}</h2>
            </div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 offset-lg-4">
            <div class="section-heading text-center">
              <h6>| {{__('Contact Us')}}</h6>
              <h2>{{__('Get In Touch With Our Agents')}}</h2>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="item email">
                  ...
                  <h6>info@villa.co<br><span>{{__('Business Email')}}</span></h6>
                </div>
              </div>
            </div>
          </div>
